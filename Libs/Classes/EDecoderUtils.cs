...
namespace IBApi
{
  ...
  {
    public static Contract decodeContract(protobuf.ProtoContract contractProto)
    {
    ...
    public static List<ComboLeg> decodeComboLegs(protobuf.ProtoContract contractProto)
    {
    ...
    public static List<OrderComboLeg> decodeOrderComboLegs(protobuf.ProtoContract contractProto)
    {
    ...
    public static DeltaNeutralContract decodeDeltaNeutralContract(protobuf.ProtoContract contractProto)
    {
    ...
    public static Order decodeOrder(int orderId, protobuf.ProtoContract contractProto, protobuf.ProtoOrder orderProto)
    {
    ...
    public static List<OrderCondition> decodeConditions(protobuf.ProtoOrder order)
    {
    ...
    public static SoftDollarTier decodeSoftDollarTier(protobuf.ProtoOrder order)
    {
    ...
    public static ContractDetails decodeContractDetails(protobuf.ProtoContract contractProto, protobuf.ProtoContractDetails contractDetailsProto, bool isBond)
    {
    ...
    public static List<IneligibilityReason> decodeIneligibilityReasonList(protobuf.ProtoContractDetails contractDetailsProto)
    {
