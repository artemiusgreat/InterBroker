...
namespace IBApi
{
  internal class EClientUtils
  {
    ...
    public static protobuf.PlaceOrderRequest createPlaceOrderRequestProto(int orderId, Contract contract, Order order)
    {
      ...
      protobuf.ProtoContract contractProto = createContractProto(contract, order);
      if (contractProto != null) placeOrderRequestProto.Contract = contractProto;

      protobuf.ProtoOrder orderProto = createOrderProto(order);
      if (orderProto != null) placeOrderRequestProto.Order = orderProto;

      return placeOrderRequestProto;
    }

    public static protobuf.ProtoOrder createOrderProto(Order order)
    {
      protobuf.ProtoOrder orderProto = new protobuf.ProtoOrder();
    ...
    public static protobuf.ProtoContract createContractProto(Contract contract, Order order)
    {
      protobuf.ProtoContract contractProto = new protobuf.ProtoContract();
    ...
    public static protobuf.CancelOrderRequest createCancelOrderRequestProto(int id, OrderCancel orderCancel)
    {
      ...
      protobuf.ProtoOrderCancel orderCancelProto = createOrderCancelProto(orderCancel);
    ...
    public static protobuf.ProtoOrderCancel createOrderCancelProto(OrderCancel orderCancel)
    {
      if (orderCancel == null)
      {
        return null;
      }
      protobuf.ProtoOrderCancel orderCancelProto = new protobuf.ProtoOrderCancel();
    ...
    public static protobuf.ContractDataRequest createContractDataRequestProto(int reqId, Contract contract)
    {
      ...
      protobuf.ProtoContract contractProto = createContractProto(contract, null);
